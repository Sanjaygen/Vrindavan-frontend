...
import { useCreateSubCategories } from "@/hooks/useSubCategories";
import CustomDropdown from "@/ui-components/dropdown/CustomDropDown";
import { SubCategoriesDataProps } from "../../types";
const CategoriesFields: React.FC<CreateBoxProps> = ({
    ...
    const {
        ...
        reset,
      } = useForm<SubCategoriesDataProps>({
        defaultValues: {
         category_name:"",
          name: "",
          description: "",
      ...
      const { mutate: createSubCategories } = useCreateSubCategories();
      const onSubmit = async (data: SubCategoriesDataProps) => {
...
const TabsContainer: React.FC = () => {
    ...
    return (
      <Tabs
        ...
        tabItems={[
          ...
          { id: "create", label: "Create SubCategories", icon: <AiOutlinePlus /> },
        ]}
      />
    );
  };
  
  const CreateSubCategoriesComponents: React.FC = () => {
  ...
  export default CreateSubCategoriesComponents;
