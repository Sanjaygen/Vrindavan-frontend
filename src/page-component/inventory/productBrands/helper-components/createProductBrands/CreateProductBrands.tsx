...
import { ProductBrandsCheckboxItem, ProductBrandsContainer, ProductBrandsFormGroup, ProductBrandsHelperDiv, ProductBrandsHelperText, ProductBrandsLabel } from "./CreateProductBrands.styled";
interface FormData {
    name: string;
    active: boolean;
  }
const ProductBrandsFields = () => {
  ...
  return (
    <Tabs
      ...
      tabItems={[
        ...
        { id: "create", label: "Create Product Brand", icon: <AiOutlinePlus /> },
      ]}
    />
  );
};

const CreateProductBrandsComponents: React.FC = () => {
  return (
    <CreateProductWrapper>
      <HeaderWrapper>
...
export default CreateProductBrandsComponents;
